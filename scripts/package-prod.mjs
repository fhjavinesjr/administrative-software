...
const distDir = path.join(root, "dist", "administrative");
...
console.log("Packaging administrative production build...");
...
console.log(distDir);
console.log(`Run it with: cd dist\\administrative && node server.js`);
