...
export default function Gsis() {
  const canAdd = localStorageUtil.canAdd("admin.gsis");
  const canEdit = localStorageUtil.canEdit("admin.gsis");
  const canDelete = localStorageUtil.canDelete("admin.gsis");
          ...
          {gsisData.length > 0 && (
            <div>
              <h4 className={styles.tableHeader}>
                GSIS SCHEDULE OF CONTRIBUTION FOR EMPLOYED MEMBERS
              </h4>
                      ...
                      <tr key={item.gsisContributionId}>
                        ...
                        <td>
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleDelete(item.gsisContributionId)
                            }
                            title="Delete"
                            disabled={loading}
                          >
