...
const MODULE_LIST: ModuleEntry[] = [
  ...
  {
    key: "hrm.onboarding-configuration",
  ...
  {
    key: "hrm.appointment-report",
    label: "Personnel Action Report",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  {
    key: "hrm.onboarding-report",
  ...
  {
    key: "hrm.appointment-documents",
    label: "Oath and Assumption Documents",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.rsp-evaluation-policy",
    label: "RSP Evaluation Policy",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.hrmpsb-governance",
    label: "HRMPSB Governance",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.rsp-candidate-evaluation",
    label: "RSP Candidate Evaluation",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.rsp-selection-decision",
    label: "RSP Selection Decision",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.rsp-appointment-handoff",
    label: "RSP Appointment Handoff",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.rsp-comparative-report",
    label: "RSP Comparative Evaluation Report",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  {
    key: "primehr.rsp-selection-report",
    label: "Selection and Appointment Process Record",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  {
    key: "primehr.rsp-evidence-index-report",
    label: "Confidential RSP Evidence Index",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  {
    key: "primehr.rsp-register-report",
    label: "RSP Register Report",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  {
    key: "primehr.rsp-process-analytics",
    label: "RSP Process Analytics",
    type: "module",
    indent: 0,
    hasDataScope: true,
  },
  ...
  {
    key: "primehr.performance-policy",
    label: "Performance Management Policy",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.performance-cycle",
    label: "Performance Cycle and Calendar",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.performance-rating-scale",
    label: "Performance Rating Scales",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.performance-success-indicator",
    label: "Performance Success Indicators",
    type: "module",
    indent: 0,
    hasAdd: true,
    hasEdit: true,
  ...
  {
    key: "primehr.performance-template",
