...
export default function Natureofseparation() {
  const canAdd = localStorageUtil.canAdd("admin.natureSeparation");
  const canEdit = localStorageUtil.canEdit("admin.natureSeparation");
  const canDelete = localStorageUtil.canDelete("admin.natureSeparation");
                    ...
                    <tr key={m.code ?? `row-${indx}`}>
                      ...
                      <td>
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleDelete(m.nature, m.natureOfSeparationId!)
                          }
                        >
                          <FaTrashAlt />
                        </button>
