...
export default function UserSetting() {
  const canAdd = localStorageUtil.canAdd("admin.userSetting");
  const canEdit = localStorageUtil.canEdit("admin.userSetting");
  ...
  const isReadyToSave =
    showPasswordFields && newPassword.length > 0 && confirmPassword.length > 0;
          ...
          <form className={styles.UserForm} onSubmit={handleSetPassword}>
            ...
            <div className={styles.buttonGroup}>
              <button
                type="submit"
                className={
                  isReadyToSave ? styles.saveButton : styles.searchButton
                }
                disabled={!canEdit}
              >
