...
export default function PayrollSettings() {
  const canAdd = localStorageUtil.canAdd("admin.payrollSettings");
  const canEdit = localStorageUtil.canEdit("admin.payrollSettings");
  const canDelete = localStorageUtil.canDelete("admin.payrollSettings");
        ...
        <div className={modalStyles.modalBody}>
          <form className={styles.PayrollSettingsForm} onSubmit={onSubmit}>
            ...
            <span className={styles.fieldNote}>
              Number of working days used as the salary period divisor (default:
              22).
            </span>
