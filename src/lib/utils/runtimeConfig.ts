...
export const runtimeConfig = {
  /**
   * Returns the base URL for the given backend API service.
   * Reads from localStorage first; falls back to the NEXT_PUBLIC_ env var.
   */
  ...
  /**
   * Returns the UI URL for the given frontend application.
   * Reads from localStorage first; falls back to the NEXT_PUBLIC_ env var.
   */
  ...
  /**
   * Returns the inactivity timeout in seconds.
   * Reads from localStorage first; falls back to NEXT_PUBLIC_INACTIVITY_TIMEOUT env var.
   */
